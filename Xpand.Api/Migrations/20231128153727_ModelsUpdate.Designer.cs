...
namespace Xpand.Api.Migrations
{
    ...
    [Migration("20231128153727_ModelsUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Xpand.Api.Models.Team", b =>
                {
                    ...
                    b.HasIndex("ShuttleId")
                        .IsUnique()
                        .HasFilter("[ShuttleId] IS NOT NULL");
            ...
            modelBuilder.Entity("Xpand.Api.Models.Team", b =>
                {
                    b.HasOne("Xpand.Api.Models.Shuttle", "Shuttle")
                        .WithOne("Team")
                        .HasForeignKey("Xpand.Api.Models.Team", "ShuttleId")
                        .OnDelete(DeleteBehavior.SetNull);
